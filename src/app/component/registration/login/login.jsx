  ...
  return (
    <Styled.LoginContainer>
      ...
      <Styled.LoginDescription>
        ...
        <Styled.DescriptionLink href="/login"> Click here</Styled.DescriptionLink> to get started.
      </Styled.LoginDescription>
      
      <Styled.LoginDescription>
        If you signed up but didn't get your verification email,{' '}
        <Styled.DescriptionLink href="/login">click here</Styled.DescriptionLink> to have it resent.
      </Styled.LoginDescription>
      ...
      <Styled.LoginForm>
        ...
        <Styled.ButtonContainer>
          ...
          <Styled.ResetPasswordLink href="/login">Reset Password</Styled.ResetPasswordLink>
        </Styled.ButtonContainer>
      </Styled.LoginForm>
    </Styled.LoginContainer>
  );
