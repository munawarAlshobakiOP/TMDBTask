...
import H1Section from './BoxFilter';
import { Event_Icon, KeyboardArrowDown_Icon } from '../../assests/icons';
          ...
          <Styles.SectionContent>
            ...
            <Styles.ReleaseDates>
              ...
              <Styles.Dates>
                ...
                <Styles.Calender>
                  ...
                  />
                  <Styles.CalenderButton><Event_Icon/></Styles.CalenderButton>
                </Styles.Calender>
              </Styles.Dates>
              <Styles.Dates className="to-date-row">
                <label>to:</label>
                <Styles.Calender>
                  <Styles.ToDate
                    type='date'
            ...
            <Styles.Language ref={dropdownRef}>
              ...
              <Styles.LanguageDropdown>
                <Styles.LanguageInputWrapper>
                  <Styles.LanguageSearchInput
                    type='text'
                    placeholder='Search language...'
                    value={
                      dropdownOpen ? languageSearch : getSelectedLanguageName()
                    }
                    onChange={handleSearchChange}
                    onFocus={handleInputFocus}
                    readOnly={!dropdownOpen}
                  />
                  <Styles.LanguageDropdownIcon>
                    <KeyboardArrowDown_Icon />
                  </Styles.LanguageDropdownIcon>
                </Styles.LanguageInputWrapper>
