    ...
    return (
      <MovieStyled.ErrorContainer>
        <MovieStyled.ErrorContent>
          ...
          <MovieStyled.RetryButton onClick={() => window.location.reload()}>
            Try Again
          </MovieStyled.RetryButton>
        </MovieStyled.ErrorContent>
      </MovieStyled.ErrorContainer>
    );
  }
          ...
          <MovieStyled.ContentArea>
            ...
            {movies.length === 0 && !isLoading ? (
              <MovieStyled.NoMoviesContainer>
                <MovieStyled.NoMoviesTitle>
                  No movies found
                </MovieStyled.NoMoviesTitle>
                <MovieStyled.NoMoviesMessage>
